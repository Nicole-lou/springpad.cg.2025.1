...
public class NewController {
    ...
    public String createNewPad(
            ...
            @RequestParam("patcontent") String content,
        ...
        if (optionalOwner.isEmpty()) {
            // Caso o owner não seja encontrado (ex.: UID inválido), redireciona para login ou erro
            return "redirect:/login"; // Ou uma página de erro personalizada
        }
        ...
        if (sanitizedTitle.isEmpty()) {
            ...
            return "redirect:/pad/novo"; // Idealmente, passar erro via model, mas mantendo simples
        }
        ...
        redirectAttributes.addFlashAttribute("successMessage", "Pad \\\"" + sanitizedTitle + "\\\" cadastrado com sucesso!");
